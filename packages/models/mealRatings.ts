...
export class MealRating implements IMealRating {
  ...
  constructor(input: Partial<MealRating> = {}) {
...
export interface IMealRatingCreationRequestInput {
  mealID: NonNullable<string>;
  notes: NonNullable<string>;
  byUser: NonNullable<string>;
  taste: NonNullable<number>;
...
export class MealRatingCreationRequestInput implements IMealRatingCreationRequestInput {
  mealID: NonNullable<string> = '';
  notes: NonNullable<string> = '';
  byUser: NonNullable<string> = '';
  taste: NonNullable<number> = 0;
  ...
  constructor(input: Partial<MealRatingCreationRequestInput> = {}) {
    this.mealID = input.mealID ?? '';
    this.notes = input.notes ?? '';
    this.byUser = input.byUser ?? '';
    this.taste = input.taste ?? 0;
...
export interface IMealRatingUpdateRequestInput {
  mealID?: string;
  taste?: number;
  difficulty?: number;
  cleanup?: number;
...
export class MealRatingUpdateRequestInput implements IMealRatingUpdateRequestInput {
  mealID?: string;
  taste?: number;
  difficulty?: number;
  cleanup?: number;
  ...
  constructor(input: Partial<MealRatingUpdateRequestInput> = {}) {
    this.mealID = input.mealID;
