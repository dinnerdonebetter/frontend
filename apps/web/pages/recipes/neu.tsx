              ...
              <Grid.Col md="auto" sm={12}>
                <Stack>
                  <Autocomplete
                    ...
                    onItemSubmit={(value: AutocompleteItem) => {
                      ...
                      updatePageState((x: NewRecipeCreationPageState) => {
                        ...
                        x.steps[stepIndex].preparation = selectedPreparation;
                        ...
                        <IconCircleX
                          ...
                          onClick={() => {
                            ...
                            updatePageState((x: NewRecipeCreationPageState) => {
                              ...
                              x.preparationQueryToExecute = null;
                              x.steps[stepIndex].preparation = null;
                  ...
                  <Autocomplete
                    label="Ingredient(s)"
                    required={
                      Boolean(step.preparation?.minimumIngredientCount) &&
                      step.ingredients.length < (step.preparation?.minimumIngredientCount || -1)
                    }
                    error={
                      (step.preparation?.minimumIngredientCount || -1) > step.ingredients.length
                    ...
                    disabled={
                      ...
                      (step.preparation?.maximumIngredientCount || -1) === step.ingredients.length
                    }
                  ...
                  <Select
                    label="Instrument(s)"
                    required={
                      Boolean(step.preparation?.minimumInstrumentCount) &&
                      step.instruments.length < (step.preparation?.minimumInstrumentCount || -1)
                    }
                    error={
                      (step.preparation?.minimumInstrumentCount || -1) > step.instruments.length
                    ...
                    disabled={
                      (step.preparation?.maximumInstrumentCount || Number.MAX_SAFE_INTEGER) <=
                    ...
                    <Grid key={productIndex}>
                      ...
                      <Grid.Col md="auto" sm={12}>
                        <Autocomplete
                          ...
                          disabled={
                            !Boolean(step.preparation) && product.type === 'ingredient' && step.ingredients.length === 0
                          }
                          error={
                            Boolean(step.preparation) &&
                          ...
                          required={Boolean(step.preparation) && step.ingredients.length > 0}
                      ...
                      <Grid.Col span="auto">
                        <TextInput
                          required={Boolean(step.preparation)}
                          error={Boolean(step.preparation) ? 'required' : ''}
                          label="Product Name"
            ...
            <Button
              ...
              disabled={
                pageState.steps.filter((recipeStep: NewRecipeStepCreationPageState) => {
                  return recipeStep.preparation === null;
                }).length !== 0
              }
            >
              Add Step
