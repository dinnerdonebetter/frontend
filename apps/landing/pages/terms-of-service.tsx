...
export default function PrivacyPolicyPage(): JSX.Element {
  return (
    <>
      <Title order={1}>NOTE: THIS IS A PLACEHOLDER MADE BY CHAT GPT! IGNORE THIS!</Title>

      <Text>
        Effective Date: [Date] Please read these Terms of Service (&quot;Terms&quot;) carefully before using our cooking
        app (&quot;App&quot;). By accessing or using the App, you agree to be bound by these Terms. If you do not agree
        with any part of these Terms, you may not use the App. Use of the App 1.1 Eligibility:
        <p>
          You must be at least 13 years old to use the App. By using the App, you represent and warrant that you are 13
          years of age or older. If you are under the age of 18, you must have the permission of a parent or guardian to
          use the App.
        </p>
        1.2 License:
        <p>
        ...
        <p>
          ...
          infringe upon the rights of any third party, including copyrights, trademarks, or privacy rights. You must not
          submit any offensive, illegal, or inappropriate content.
        </p>
        2.3 Monitoring and Removal:
        <p>
          We have the right to monitor User Content and may remove or modify any content that violates these Terms or is
          otherwise objectionable. We are not responsible for any loss, damage, or liability arising from the removal or
        ...
        <p>
          ...
          whether express or implied. We do not warrant that the App will be error-free, secure, or uninterrupted. Your
        ...
        <p>
          ...
          attorneys&apos; fees) arising out of or related to your use of the App, your violation of these Terms, or your
